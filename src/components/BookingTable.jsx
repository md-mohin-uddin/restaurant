...
const BookingTable = () => {
  return (
    <section
      className="bg-cover bg-center py-16 px-8 text-white"
      style={{
    ...
    >
      <div className="w-3/4 mx-auto flex flex-col lg:flex-row items-center justify-between lg:space-x-8">
        <div className="lg:w-1/2">
          <h2 className="text-red-500 text-sm font-semibold mb-2">
            <span className="inline-block w-2 h-2 bg-red-600 mr-2"></span>Book
            Now
          </h2>
          <h1 className="text-4xl font-bold mb-4 title">BOOK YOUR TABLE</h1>
